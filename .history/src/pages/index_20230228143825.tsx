...
return(
  ...
  <main>
    <div className={`${styles.post} ${commonStyles.maximumSize}`}>
      ...
      {nextPage !=null ? <a href='#' onClick={nextPagePost} className={styles.carregarPost}>Carregar mais post</a> :<strong className={styles.carregarPost}>Não existe mais posts</strong>}
